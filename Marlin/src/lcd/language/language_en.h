...
namespace Language_en {
  ...
  PROGMEM Language_Str MSG_MARLIN                          = _UxGT("Leantronic"); //Tobbe
  ...
  PROGMEM Language_Str MSG_START_PRINT                     = _UxGT("Start Job");
  ...
  PROGMEM Language_Str MSG_BUTTON_PRINT                    = _UxGT("Run");
  ...
  PROGMEM Language_Str MSG_RESUME_PRINT                    = _UxGT("Resume Job");
  ...
  PROGMEM Language_Str MSG_MEDIA_MENU                      = _UxGT("Run Job from Media");
  ...
  PROGMEM Language_Str MSG_PRINT_ABORTED                   = _UxGT("Job Aborted");
  ...
  PROGMEM Language_Str MSG_INFO_MENU                       = _UxGT("About Liquid Handler");
