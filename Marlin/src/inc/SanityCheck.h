...
constexpr float hbm[] = HOMING_BUMP_MM; //Tobbe
static_assert(COUNT(hbm) == XYZE, "HOMING_BUMP_MM requires X, Y, Z and E elements.");
...
static_assert(hbm[E_AXIS] >= 0, "HOMING_BUMP_MM.Z must be greater than or equal to 0.");
#else
constexpr float hbm[] = HOMING_BUMP_MM; //Tobbe
